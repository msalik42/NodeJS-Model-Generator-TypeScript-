...
export interface oldCompetencyAttributes {
    id?: number;
    competencyId?: string;
...
@Table({
	tableName: "old_competency",
	timestamps: false 
})
export class oldCompetency extends Model<oldCompetencyAttributes, oldCompetencyAttributes> implements oldCompetencyAttributes {
